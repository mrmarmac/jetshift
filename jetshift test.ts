...
// Stub imports — replace with actual module imports when building
declare function computeCBTMinimum(sleep: string, wake: string, chronotype: string): string;
declare function detectTravelDirection(originTZ: string, destTZ: string): 'east' | 'west' | 'minimal';
declare function computeLightWindows(cbtMin: string, direction: string): any;
declare function advanceCBTMinimum(cbtMin: string, direction: string, lightCompliance: boolean): string;
declare function generatePlan(input: any): any;
declare function computeFlightDuration(dep: string, originTZ: string, arr: string, destTZ: string): number;
declare function layoverPhaseWindows(layovers: any[], cbtMin: string, direction: string): any[];
declare function convertToHomeTime(localDT: string, fromTZ: string, toTZ: string): any;
declare function generateMealSchedule(wakeTime: string, direction: string, dayIndex: number, opts?: any): any[];
declare function assembleHourlyBlocks(params: any): any[];
declare function validateUserInput(input: any): { valid: boolean; errors: string[] };
declare function savePlan(plan: any): Promise<void>;
declare function getPlan(id: string): Promise<any | null>;
declare function listPlans(): Promise<any[]>;
declare function deletePlan(id: string): Promise<void>;
declare function clearPlanStorage(): Promise<void>;
declare type Action = { type: string; label: string; priority: string; localTime: string };
